/**
 * postprocessing v6.32.2 build Sun Jul 16 2023
...
var EffectComposer = class {
  ...
  onSessionStateChange() {
    const size = this.renderer.getSize(new Vector217());
    this.setSize(size.width, size.height);
  }
  /**
  ...
  constructor({
    ...
    super("LensDistortionEffect", lens_distortion_default, {
      uniforms: /* @__PURE__ */ new Map([
        ...
        // radial distortion coeff 0 // radial distortion coeff of term r^2
...
import { FloatType as FloatType4, HalfFloatType, Uniform as Uniform37 } from "three";
